 ...
 *
 *         double y1=add_2(double u1, double u2,double u3)
 *
 *    Simulink version           : 9.2 (R2018b) 24-May-2018
 *    C source code generated on : 06-Mar-2019 10:54:43
 *
...
/**
     ...
     def.SFunctionName = 'MUL';
     def.OutputFcnSpec = 'double y1=add_2(double u1, double u2,double u3)';
